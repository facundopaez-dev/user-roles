app.controller(
    "ClimateRecordCtrl",
    ["$scope", "$location", "$routeParams", "ExpirationSrv", "ClimateRecordSrv", "ParcelSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager",
        function ($scope, $location, $params, expirationSrv, service, parcelService, accessManager, errorResponseManager, authHeaderManager) {
