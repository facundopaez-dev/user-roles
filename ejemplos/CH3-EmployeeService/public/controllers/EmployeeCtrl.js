app.controller(
  "EmployeeCtrl",
  ["$scope", "$location", "$routeParams", "EmployeeSrv", "ExpirationSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager", "LogoutManager",
    function ($scope, $location, $params, servicio, expirationSrv, accessManager, errorResponseManager, authHeaderManager, logoutManager) {
