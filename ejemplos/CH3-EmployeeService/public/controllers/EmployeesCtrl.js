app.controller(
	"EmployeesCtrl",
	["$scope", "$location", "$route", "EmployeeSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager", "LogoutManager",
		function ($scope, $location, $route, servicio, accessManager, errorResponseManager, authHeaderManager, logoutManager) {
