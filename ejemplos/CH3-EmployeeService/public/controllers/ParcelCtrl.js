app.controller(
    "ParcelCtrl",
    ["$scope", "$location", "$routeParams", "ExpirationSrv", "ParcelSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager",
        function ($scope, $location, $params, expirationSrv, service, accessManager, errorResponseManager, authHeaderManager) {
