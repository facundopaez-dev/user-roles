app.controller(
    "ParcelCtrl",
    ["$scope", "$location", "$routeParams", "ExpirationSrv", "ParcelSrv", "AccessManager", "ErrorResponseManager", "AuthHeaderManager", "LogoutManager",
        function ($scope, $location, $params, expirationSrv, service, accessManager, errorResponseManager, authHeaderManager, logoutManager) {
