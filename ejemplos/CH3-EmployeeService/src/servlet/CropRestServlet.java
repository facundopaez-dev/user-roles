...
public class CropRestServlet {
  ...
  public Response create(@Context HttpHeaders request, String json) throws IOException {
    ...
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.create(newCrop))).build();
  }
  ...
  public Response modify(@Context HttpHeaders request, @PathParam("id") int id, String json) throws IOException {
    ...
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.modify(id, modifiedCrop))).build();
  }
