...
public class EmployeeRestServlet {
  ...
  @Path("/{id}")
  @Produces(MediaType.APPLICATION_JSON)
  public Response find(@Context HttpHeaders request, @PathParam("id") int employeeId) throws IOException {
    Response givenResponse = RequestManager.validateAuthHeader(request, secretKeyService.find());
     ...
     * solicitada
     */
    if (!service.checkExistence(employeeId)) {
     ...
     * por el cliente
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.find(userId, employeeId))).build();
  }
  ...
  @Path("/{id}")
  @Produces(MediaType.APPLICATION_JSON)
  public Response remove(@Context HttpHeaders request, @PathParam("id") int employeeId) throws IOException {
    Response givenResponse = RequestManager.validateAuthHeader(request, secretKeyService.find());
     ...
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.remove(userId, employeeId))).build();
  }

  @PUT
  @Path("/{id}")
  @Produces(MediaType.APPLICATION_JSON)
  public Response modifySalary(@Context HttpHeaders request, @PathParam("id") int employeeId, @QueryParam("salary") long newSalary) throws IOException {
    Response givenResponse = RequestManager.validateAuthHeader(request, secretKeyService.find());
     ...
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.modifySalary(userId, employeeId, newSalary))).build();
  }
