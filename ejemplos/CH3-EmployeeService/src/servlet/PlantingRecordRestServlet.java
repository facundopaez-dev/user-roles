...
public class PlantingRecordRestServlet {
  ...
  public Response find(@Context HttpHeaders request, @PathParam("id") int plantingRecordId) throws IOException {
     ...
     * solicitada
     */
    if (!service.checkExistence(plantingRecordId)) {
     ...
     * por el cliente
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.find(userId, plantingRecordId))).build();
  }
  ...
  public Response create(@Context HttpHeaders request, String json) throws IOException {
    ...
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.create(newPlantingRecord))).build();
  }
  ...
  public Response remove(@Context HttpHeaders request, @PathParam("id") int plantingRecordId) throws IOException {
     ...
     */
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.remove(userId, plantingRecordId))).build();
  }
  ...
  public Response modify(@Context HttpHeaders request, @PathParam("id") int plantingRecordId, String json) throws IOException {
    ...
    return Response.status(Response.Status.OK).entity(mapper.writeValueAsString(service.modify(userId, plantingRecordId, modifiedPlantingRecord))).build();
  }
